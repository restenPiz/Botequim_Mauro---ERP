                                    ...
                                    <div class="invoice-actions">
                                      <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                          <div class="dropdown-arrow mr-1"></div><button type="button" id="download-pdf" class="dropdown-item">Download PDF</button> <button type="button" class="dropdown-item">Share...</button>
                                          <div class="dropdown-divider"></div><button type="button" class="dropdown-item">Mark as paid</button>
                                        </div>
                                      </div>
                                    </div><!-- /.invoice-actions -->
                                    <!-- .invoice -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col d-flex">
                                            <h2 class="invoice-brand align-self-center">
                                              <img src="assets/images/brand-logo.png" width="124" alt=""> <span class="sr-only">Invoice Brand</span>
                                            </h2>
                                          </div><!-- /.col -->
                                          <!-- .col -->
                                          <div class="col">
