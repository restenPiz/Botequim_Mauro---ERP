                            ...
                            <div class="row">
                                            ...
                                            <div class="card card-fluid">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <label for="input02">Valor a Pagar</label> <input
                                                                type="text" class="form-control"
                                                                placeholder="Valor a Pagar" id="input02"
                                ...
                                <div class="col-lg-8">
                                    <div class="col">
                                                        ...
                                                        <tbody>
                                                            @foreach ($sales as $sale)
                                                                <tr>
                                                                    ...
                                                                    <td class="align-middle">
                                                                        {{ $sale->payments->Name_payment }} </td>
                                                                    <td class="align-middle">{{ $sale->Total_price }}</td>
                                                                    <td class="align-middle text-right">
                                                                        <button type="button"
                                                                            class="btn btn-sm btn-icon btn-secondary"
                                                                            data-toggle="modal"
                                                                            data-target="#clientNewModal"><i
                                        ...
                                        <div class="col">
                                            <button type="submit" name="submit"
                                                class="btn btn-success text-nowrap ml-auto" onclick="enableField()">Concluir
                                                Venda</button>
                                        </div>
