                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" value="" class="form-control" id="Quantity"
                                                        placeholder="Quantidade" name="Quantity" disabled required>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input01">Codigo de Barra</label>
                                                    <input type="text" value="" class="form-control" id="Code"
                                                        placeholder="Codigo de Barra" name="Code" disabled required>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input02">Preco do Produto</label>
                                                    <input type="text" value="" class="form-control" id="Price"
                                                        placeholder="Preco do Produto" name="Price" disabled required>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input01">Data de Entrada</label>
                                                    <input type="date" value="" class="form-control" id="Entry_date"
                                                        name="Entry_date" disabled required>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input01">Data de Validade</label>
                                                    <input type="date" value="" class="form-control" id="Expiry_date"
                                                        name="Expiry_date" disabled required>
                                                </div><!-- /form column -->
                                            </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-header">
                                                            <h6 id="clientNewModalLabel" class="modal-title inline-editable">
                                                                <span class="sr-only">Formulario de Acrescimo de
                                                                    Productos</span>
                                                            </h6>
                                                        </div><!-- /.modal-header -->
                                                        <!-- .modal-body -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="Quantity"
                                                                id="quantity" placeholder="Digite a quantidade desejada">
                                                        </div>
                                                        <!-- /.form-row -->
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="submit" class="btn btn-primary"
                                                            onclick="enableField()">Fazer Acrescimo no
                                                            Producto</button>
                                            ...
                                            @foreach ($stocks as $stock)
                                                    ...
                                                    <td class="align-middle text-right">
                                                        <button type="button" class="btn btn-sm btn-icon btn-secondary"
                                                            ...
                                                            class="btn btn-sm btn-icon btn-secondary"><i
                                                                ...
                                                                data-target="#deleteRecordModal{{ $stock->id }}"
                                                ...
                                                <div class="modal fade zoomIn" id="deleteRecordModal{{ $stock->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <form action="{{ route('deleteStock', ['id' => $stock->id]) }}"
                                                                method="get">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="modal-body">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="form-control" name="Id_product"
                                                                                    id="Id_product" onchange="prod(this);">
                                                                                    <option value="{{ $stock->Id_product }}">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" id="entry_date"
                                                                                    class="form-control" name="Entry_date"
                                                                                    value=""
                                                                                    placeholder="{{ $stock->Entry_date }}"
                                                                                    disabled>
                                                                            </div>
                                                                            <div class="form-group">
                                        ...
                                        <form method="post" action="{{ route('storeStock') }}">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label>Nome de Producto</label>
                                                    {{-- Inicio do input de selecao de Productos --}}
                                                    <select class="form-control" name="Id_product" id="Product_name"
                                                        onchange="productos(this);">
                                                        <option>--Selecione o Produto--</option>
                                                        @foreach ($products as $stock)
                                                            <option value="{{ $stock->id }}">{{ $stock->Product_name }}
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="input02">Quantidade</label>
                                                    <input type="text" value="" class="form-control" id="Quantity"
                                                        placeholder="Quantidade" name="Quantity" disabled>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input01">Codigo de Barra</label>
                                                    <input type="text" value="" class="form-control" id="Code"
                                                        placeholder="Codigo de Barra" name="Code" disabled>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input02">Preco do Produto</label>
                                                    <input type="text" value="" class="form-control" id="Price"
                                                        placeholder="Preco do Produto" name="Price" disabled>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input01">Data de Entrada</label>
                                                    <input type="date" value="" class="form-control"
                                                        id="Entry_date" name="Entry_date" disabled>
                                                </div><!-- /form column -->
                                                <!-- form column -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="input01">Data de Validade</label>
                                                    <input type="date" value="" class="form-control"
                                                        id="Expiry_date" name="Expiry_date" disabled>
                                                </div><!-- /form column -->
                                            </div>
                                            <button type="submit" name="submit" class="btn btn-primary text-nowrap ml-auto"
