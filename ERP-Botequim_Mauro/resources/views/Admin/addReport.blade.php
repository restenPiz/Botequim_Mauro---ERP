                ...
                <div class="section-block d-flex justify-content-between align-items-center my-3">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-secondary" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"><span>This Month</span> <i class="fa fa-fw fa-caret-down"></i></button>
                        <!-- .dropdown-menu -->
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-md stop-propagation">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="dpToday" name="dpFilter"
                                    value="0"> <label class="custom-control-label d-flex justify-content-between"
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="dpYesterday" name="dpFilter"
                                    ...
                                    for="dpYesterday"><span>Yesterday</span> <span class="text-muted">Mar 26</span></label>
                            </div><!-- /.custom-control -->
                            <!-- .custom-control -->
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="dpWeek" name="dpFilter"
                                    value="2"> <label class="custom-control-label d-flex justify-content-between"
                                    for="dpWeek"><span>This Week</span> <span class="text-muted">Mar 21-27</span></label>
                            </div><!-- /.custom-control -->
                            <!-- .custom-control -->
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="dpMonth" name="dpFilter"
                                    value="3" checked> <label
                                    class="custom-control-label d-flex justify-content-between" for="dpMonth"><span>This
                                        Month</span> <span class="text-muted">Mar 1-31</span></label>
                            </div><!-- /.custom-control -->
                            <!-- .custom-control -->
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="dpYear" name="dpFilter"
                                    value="4"> <label class="custom-control-label d-flex justify-content-between"
                                    for="dpYear"><span>This Year</span> <span class="text-muted">2019</span></label>
                            </div><!-- /.custom-control -->
                            <!-- .custom-control -->
                            <div class="custom-control custom-radio">
                                ...
                                <div class="custom-control-hint my-1">
                                    <!-- datepicker:range -->
                                    <input type="text" class="form-control" data-toggle="flatpickr" data-mode="range"
                ...
                <div class="card-deck-xl">
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="list-group list-group-bordered list-group-reflow">
                            ...
                            <div class="list-group-item justify-content-between align-items-center">
                                <span><i class="fas fa-square text-teal mr-2"></i> Conversion to clients</span> <span
                                    class="text-muted">1.5%</span>
                            </div>
                        </div><!-- /.list-group -->
                    </div><!-- /.card -->
                    <!-- .card -->
                                ...
                                <div class="list-group-item-body">
                                    ...
                                    <div class="progress progress-animated rounded-0" data-toggle="tooltip"
                                        ...
                                        <div class="progress-bar bg-teal" role="progressbar"
                                            aria-valuenow="15.184980673660961" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 15.184980673660961%">
                                            <span class="sr-only">15.184980673660961% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-indigo" role="progressbar"
                                            aria-valuenow="33.90392048591938" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 33.90392048591938%">
                                            <span class="sr-only">33.90392048591938% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-pink" role="progressbar"
                                            aria-valuenow="29.486471562672556" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 29.486471562672556%">
                                            <span class="sr-only">29.486471562672556% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-purple" role="progressbar"
                                            aria-valuenow="21.424627277747103" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 21.424627277747103%">
                            ...
                            <div class="list-group-item">
                                ...
                                <div class="list-group-item-body">
                                    ...
                                    <div class="progress progress-animated rounded-0" data-toggle="tooltip"
                                        ...
                                        <div class="progress-bar bg-teal" role="progressbar"
                                            aria-valuenow="33.84053560559951" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 33.84053560559951%">
                                            <span class="sr-only">33.84053560559951% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-indigo" role="progressbar"
                                            aria-valuenow="24.71089470480828" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 24.71089470480828%">
                                            <span class="sr-only">24.71089470480828% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-pink" role="progressbar"
                                            aria-valuenow="26.29336579427876" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 26.29336579427876%">
                                            <span class="sr-only">26.29336579427876% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-purple" role="progressbar"
                                            aria-valuenow="15.15520389531345" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 15.15520389531345%">
                            ...
                            <div class="list-group-item">
                                ...
                                <div class="list-group-item-body">
                                    ...
                                    <div class="progress progress-animated rounded-0" data-toggle="tooltip"
                                        ...
                                        <div class="progress-bar bg-teal" role="progressbar"
                                            aria-valuenow="6.815020862308762" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 6.815020862308762%">
                                            <span class="sr-only">6.815020862308762% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-indigo" role="progressbar"
                                            aria-valuenow="40.82058414464534" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 40.82058414464534%">
                                            <span class="sr-only">40.82058414464534% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-pink" role="progressbar"
                                            aria-valuenow="18.845618915159946" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 18.845618915159946%">
                                            <span class="sr-only">18.845618915159946% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-purple" role="progressbar"
                                            aria-valuenow="33.51877607788595" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 33.51877607788595%">
                            ...
                            <div class="list-group-item">
                                ...
                                <div class="list-group-item-body">
                                    ...
                                    <div class="progress progress-animated rounded-0" data-toggle="tooltip"
                                        ...
                                        <div class="progress-bar bg-teal" role="progressbar"
                                            aria-valuenow="24.05431619786615" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 24.05431619786615%">
                                            <span class="sr-only">24.05431619786615% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-indigo" role="progressbar"
                                            aria-valuenow="19.88360814742968" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 19.88360814742968%">
                                            <span class="sr-only">19.88360814742968% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-pink" role="progressbar"
                                            aria-valuenow="41.41610087293889" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 41.41610087293889%">
                                            <span class="sr-only">41.41610087293889% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-purple" role="progressbar"
                                            aria-valuenow="14.645974781765277" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 14.645974781765277%">
                            ...
                            <div class="list-group-item">
                                ...
                                <div class="list-group-item-body">
                                    ...
                                    <div class="progress progress-animated rounded-0" data-toggle="tooltip"
                                        ...
                                        <div class="progress-bar bg-teal" role="progressbar"
                                            aria-valuenow="11.452810180275716" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 11.452810180275716%">
                                            <span class="sr-only">11.452810180275716% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-indigo" role="progressbar"
                                            aria-valuenow="28.101802757158005" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 28.101802757158005%">
                                            <span class="sr-only">28.101802757158005% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-pink" role="progressbar"
                                            aria-valuenow="46.977730646871684" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 46.977730646871684%">
                                            <span class="sr-only">46.977730646871684% Complete</span>
                                        </div>
                                        <div class="progress-bar bg-purple" role="progressbar"
                                            aria-valuenow="13.467656415694591" aria-valuemin="0" aria-valuemax="100"
                                            style="width: 13.467656415694591%">
