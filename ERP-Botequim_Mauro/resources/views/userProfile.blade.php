                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="media mb-3">
                                                ...
                                                <div class="user-avatar user-avatar-xl fileinput-button">
                                                    <div class="fileinput-button-label"> </div><img src="../assets/dif.jpg"
                                                        alt=""> <input id="fileupload-avatar" type="file"
                                                        name="avatar">
                                                </div><!-- /avatar -->
                                                <!-- .media-body -->
                                            ...
                                            <form method="post"
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ Auth::user()->name }}" id="input01"
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ Auth::user()->Surname }}" id="input02"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email"
                                                        ...
                                                        value="{{ Auth::user()->email }}" id="input03"
                                                        placeholder="Ex: contacto@mauropeniel.info" name="email">
                                                    @error('email')
                                                        <div class="invalid-feedback">
                                                            <i class="fa fa-exclamation-circle fa-fw"></i> {{ $message }}
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        value="{{ old('password_confirmation') }}" id="input05"
                                                        placeholder="Digite novamente a sua senha" name="password_confirmation">
                                                ...
                                                <div class="form-actions">
                                                    <button type="submit" class="btn btn-primary ml-auto">Actualizar
                                                        Perfil</button>
                                                </div><!-- /.form-actions -->
                                            </form><!-- /form -->
                                        </div><!-- /.card-body -->
                                    ...
                                    <div class="card card-fluid">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post"
                                                ...
                                                <input type="hidden" name="id" value="{{ Auth::user()->id }}">
                                                <input type="hidden" name="user_type" value="Stock_manager">
